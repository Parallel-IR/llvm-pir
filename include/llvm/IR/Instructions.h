...
class ForkInst : public TerminatorInst {
  /// Ops list - The operands are ordered: forked, continue
  ...
  ForkInst(LLVMContext &Context, BasicBlock *Forked, BasicBlock *Continue,
           Instruction *InsertBefore = nullptr);
  ForkInst(LLVMContext &Context, BasicBlock *Forked, BasicBlock *Continue,
           BasicBlock *InsertAtEnd);
...
public:
  static ForkInst *Create(LLVMContext &C, BasicBlock *Forked,
                          BasicBlock *Continue,
                          Instruction *InsertBefore = nullptr) {
    return new (2) ForkInst(C, Forked, Continue, InsertBefore);
  }
  static ForkInst *Create(LLVMContext &C, BasicBlock *Forked,
                          BasicBlock *Continue, BasicBlock *InsertAtEnd) {
    return new (2) ForkInst(C, Forked, Continue, InsertAtEnd);
  }
  ...
  BasicBlock *getSuccessor(unsigned idx) const {
    ...
    return cast_or_null<BasicBlock>((&Op<0>() + idx)->get());
  }
...
template <>
struct OperandTraits<ForkInst> : public FixedNumOperandTraits<ForkInst, 2> {};
...
class HaltInst : public TerminatorInst {
  ...
  explicit HaltInst(LLVMContext &C, BasicBlock *ForkContinue,
                    Instruction *InsertBefore = nullptr);
  HaltInst(LLVMContext &C, BasicBlock *ForkContinue, BasicBlock *InsertAtEnd);
...
class JoinInst : public TerminatorInst {
  ...
  explicit JoinInst(LLVMContext &Context, BasicBlock *Continue,
                    Instruction *InsertBefore = nullptr);
  JoinInst(LLVMContext &Context, BasicBlock *Continue, BasicBlock *InsertAtEnd);
...
public:
  static JoinInst *Create(LLVMContext &C, BasicBlock *Continue,
                          Instruction *InsertBefore = nullptr) {
    return new (1) JoinInst(C, Continue, InsertBefore);
  }
  static JoinInst *Create(LLVMContext &C, BasicBlock *Continue,
                          BasicBlock *InsertAtEnd) {
    return new (1) JoinInst(C, Continue, InsertAtEnd);
  }
